...
URL_DOCUMENTO_CORNARE = (
    "https://www.cornare.gov.co/PORH/"
    "Informe_Final_Implementacion_PORH_2022final_anexos.pdf"
)
    ...
    if error:
        ...
        if not registros:
            ...
            st.warning(
                ...
                "y rango de fechas. Prueba otro código "
                "u otro rango."
            )
            ...
            st.subheader("📊 Resumen de la estación")
